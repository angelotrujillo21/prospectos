                                    ...
                                    <div class="card-header border-bottom">
                                        <div class="d-flex align-items-center bd-highlight">
                                            ...
                                            <div class="bd-highlight">
                                                <button data-toggle="modal" data-target="#formVendedores" class="btn btn-gradient-primary btn-rounded btn-icon">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="flex-center">
                                                                <div class="dot"></div>
                                                                <span class="mx-1"> Super 1</span>
                                                            </div>
                                                        </td>
                                                        <td>DNI</td>
                                                        <td>75348133</td>
                                                        <td>Anngelo </td>
                                                        <td>Trujillo Orozcco</td>
                                                        <td>Soltero</td>
                                                        <td>0</td>
                                                        <td>21/02/2000</td>
                                                        <td>Ninguna</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formVendedoresLabel">Nuevo vendedor</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="" class="col-form-label">Experiencia en ventas:</label>
                                    <select name="" class="form-control" id="">
                                        <option value="">Seleccionar</option>
                                    </select>
                                </div>
